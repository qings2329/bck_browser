...
var defaultCurrency = localStorage.getItem('insight-currency') || 'BCK';
...
angular.module('insight').config(function($routeProvider) {
  $routeProvider.
    ...
    when('/blocks', {
      ...
      title: 'BtcKing Blocks solved Today'
    }).
    when('/blocks-date/:blockDate/:startTimestamp?', {
      templateUrl: 'views/block_list.html',
      title: 'BtcKing Blocks solved '
    }).
    when('/address/:addrStr', {
      templateUrl: 'views/address.html',
      title: 'BtcKing Address '
    }).
    when('/status', {
